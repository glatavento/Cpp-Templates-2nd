...
\filename{basics/lessstring.hpp}
\begin{cpp}
...
\begin{notice}类型X(\&)[]——对于某些任意类型X——参数仅在C++17中有效，通过核心问题393的解决。在语言的早期版本中，许多编译器也可以接受这样的参数。
\end{notice}
